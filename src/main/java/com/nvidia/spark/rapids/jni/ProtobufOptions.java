...
public class ProtobufOptions {
    ...
    /**
     * Get the schema as a list of field names.
     */
    public List<String> getSchema() {
        List<String> schema = new ArrayList<>();
        for (FieldInfo field : fields) {
            schema.add(field.getName());
        }
        return schema;
    }
    ...
    public static class Builder {
        ...
        /**
         * Add a field to read with scale (for decimal types).
         *
         * @param name Field name
         * @param fieldNumber Protocol buffer field number
         * @param dtype Data type for the field
         ...
         * @return this builder
         */
        public Builder withField(String name, int fieldNumber, DType dtype, int scale) {
            fields.add(new FieldInfo(name, fieldNumber, dtype, scale));
            return this;
        }

        /**
         * Add a field using FieldInfo.
         *
        ...
        /**
         * Check if Hadoop SequenceFile mode is enabled.
         */
        public boolean isHadoopSequenceFile() {
            return hadoopSequenceFile;
        }
